...
class TestWebhookSignatureVerification:
    ...
    def test_verify_signature_with_valid_signature(self):
        ...
        expected_signature = hmac.new(
            management_token.encode("utf-8"), body, hashlib.sha256
        ).hexdigest()
    ...
    def test_verify_signature_with_different_body(self):
        ...
        signature = hmac.new(
            management_token.encode("utf-8"), original_body, hashlib.sha256
        ).hexdigest()
...
class TestAsyncHandleWebhook:
    ...
    async def test_webhook_verify_event_missing_challenge(self):
        ...
        payload = {"eventType": "VERIFY", "vehicleId": "test_vehicle", "data": {}}
        body_bytes = json.dumps(payload).encode("utf-8")
    ...
    async def test_webhook_unknown_event_type(self):
        ...
        payload = {"eventType": "UNKNOWN_EVENT", "vehicleId": "vehicle_123", "data": {}}
        body_bytes = json.dumps(payload).encode("utf-8")
    ...
    async def test_webhook_missing_signature_header(self):
        ...
        payload = {"eventType": "VEHICLE_STATE", "vehicleId": "vehicle_123", "data": {}}
        body_bytes = json.dumps(payload).encode("utf-8")
