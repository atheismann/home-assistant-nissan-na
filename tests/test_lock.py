...
class TestLockEntityLifecycle:
    ...
    async def test_async_added_to_hass(self):
        ...
        with patch("custom_components.nissan_na.lock.async_dispatcher_connect", return_value=mock_unsub):
...
class TestAsyncSetupEntry:
    ...
    async def test_async_setup_entry_with_lock_support(self):
        ...
        mock_client.get_permissions = AsyncMock(return_value=["control_security", "read_location"])
        mock_client.get_vehicle_status = AsyncMock(return_value={"lock": {"is_locked": True}})
    ...
    async def test_async_setup_entry_permission_api_failure(self):
        ...
        mock_client.get_vehicle_status = AsyncMock(return_value={"lock": {"is_locked": False}})
