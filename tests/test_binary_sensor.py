...
class TestBinarySensorCategories:
    ...
    def test_closure_category_sensors(self):
        ...
        closure_sensors = [
            d for d in BINARY_SENSOR_DEFINITIONS if d[0].startswith("closure.")
        ]
    ...
    def test_charge_category_sensors(self):
        ...
        charge_sensors = [
            d for d in BINARY_SENSOR_DEFINITIONS if d[0].startswith("charge.")
        ]
    ...
    def test_connectivity_category_sensors(self):
        ...
        connectivity_sensors = [
            d for d in BINARY_SENSOR_DEFINITIONS if d[0].startswith("connectivity.")
        ]
    ...
    def test_battery_category_sensors(self):
        ...
        battery_sensors = [
            d for d in BINARY_SENSOR_DEFINITIONS if d[0].startswith("tractionBattery.")
        ]
    ...
    def test_surveillance_category_sensors(self):
        ...
        surveillance_sensors = [
            d for d in BINARY_SENSOR_DEFINITIONS if d[0].startswith("surveillance.")
        ]
...
class TestBinarySensorWebhookHandling:
    ...
    def test_handle_webhook_data_door_open(self):
        ...
        webhook_data = {"closure": {"doors": {"frontLeft": {"isOpen": True}}}}
    ...
    def test_handle_webhook_data_door_closed(self):
        ...
        webhook_data = {"closure": {"doors": {"frontRight": {"isOpen": False}}}}
    ...
    def test_handle_webhook_data_lock(self):
        ...
        webhook_data = {"closure": {"doors": {"frontLeft": {"isLocked": True}}}}
    ...
    def test_handle_webhook_data_connectivity(self):
        ...
        webhook_data = {"connectivity": {"isOnline": True}}
    ...
    def test_handle_webhook_data_battery_heater(self):
        ...
        webhook_data = {"tractionBattery": {"isHeaterActive": True}}
    ...
    def test_handle_webhook_data_truthiness(self):
        ...
        webhook_data = {"closure": {"doors": {"frontLeft": {"isOpen": 1}}}}
    ...
    def test_handle_webhook_data_falsy_value(self):
        ...
        webhook_data = {"closure": {"doors": {"frontLeft": {"isOpen": 0}}}}
...
class TestBinarySensorLifecycle:
    ...
    async def test_async_added_to_hass(self):
        ...
        with patch(
            "custom_components.nissan_na.binary_sensor.async_dispatcher_connect",
