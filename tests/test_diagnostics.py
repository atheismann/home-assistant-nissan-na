...
class TestAsyncGetConfigEntryDiagnostics:
    ...
    async def test_diagnostics_returns_dict(self):
        ...
        from custom_components.nissan_na.diagnostics import (
    ...
    async def test_diagnostics_includes_webhook_info(self):
        ...
        assert (
            result["webhook"]["url"]
            == "https://homeassistant.local/api/webhook/webhook_abc123"
        )
    ...
    async def test_diagnostics_handles_missing_vehicles_key(self):
        ...
        mock_hass = Mock()
        mock_hass.data = {DOMAIN: {"test_entry_id": {"sensors": {}}}}
    ...
    async def test_diagnostics_handles_missing_sensors_key(self):
        ...
        mock_hass = Mock()
        mock_hass.data = {DOMAIN: {"test_entry_id": {"vehicles": ["vehicle1"]}}}
